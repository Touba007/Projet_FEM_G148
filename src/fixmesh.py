...
if __name__ == "__main__":
    import sys
    print("\n\n>> START of fixmesh script\n")
    if len(sys.argv) < 3:
        print("Error: Incorrect usage of fixmesh.py\n")
        print("Info: Correct usage: python3 fixmesh.py_path input_mesh.txt_path output_mesh.txt_path\n")
        exit(1)
    print("Before fix:")
